...
export class Backend implements backendInterface {
    ...
    async getAllOrders(arg0: Principal): Promise<Array<Order>> {
        if (this.processError) {
            try {
    ...
    async getProductForCustomer(arg0: string): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductForCustomer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint): Promise<string> {
        if (this.processError) {
            try {
